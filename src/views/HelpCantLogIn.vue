  ...
  <div>
    <div class="col-sm-9 col-md-10 col-md-offset-4 content" id="article">
      ...
      <div class="article-content">
        <h1 class="article-header">Can't log in</h1>

        <h2>Username, password, or email address incorrect?&nbsp;</h2>
        ...
        <ol>
          ...
          <li>
            Right-click (desktop) or press and hold (mobile)&nbsp;the
        ...
        <p>
          If you signed up with a phone number but have since changed it,
          <a
