[07:11, 07/04/2020] Dai: <template>
    <div 
        class="card rounded col-lg-40%" 
        id="likedsongs" 
        testid="likedsongs card" 
        v-if="songs1.length" @mouseover="hover=true" @mouseleave="hover=false"
    >
...
<style scoped>
#likedsongs{
   background-image: linear-gradient(to bottom right,rgb(48, 48, 253), rgb(185, 172, 230));
   width: 415px;
   height: 270px;
   margin-left: 15px;
   margin-top: 15px;
